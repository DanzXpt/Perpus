...
<div class="max-w-7xl mx-auto px-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all">
            ...
            <h3 class="text-2xl font-black text-slate-800">{{ $totalStokBuku }} <span class="text-xs text-slate-400">Pcs</span></h3>
        </div>
        ...
        <div class="bg-white p-6 rounded-[2rem] border border-red-50 shadow-sm hover:shadow-md transition-all">
            ...
            <h3 class="text-2xl font-black text-red-600">{{ $terlambat }} <span class="text-xs text-slate-400">User</span></h3>
        </div>
        ...
        <div class="bg-white p-6 rounded-[2rem] border border-amber-50 shadow-sm hover:shadow-md transition-all">
            ...
            <h3 class="text-2xl font-black text-slate-800">Rp {{ number_format($totalDenda, 0, ',', '.') }}</h3>
        </div>
    ...
    <div class="bg-[#0f172a] rounded-[2.5rem] p-10 text-white relative overflow-hidden">
        <div class="relative z-10">
            ...
            <p class="text-slate-400 text-sm max-w-md">Data di atas diperbarui secara real-time berdasarkan aktivitas peminjaman yang dilakukan oleh petugas dan anggota.</p>
            <div class="mt-6 flex gap-4">
                <a href="{{ route('kepala.laporan.buku') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 rounded-xl font-bold text-xs transition-all">

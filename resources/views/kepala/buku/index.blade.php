...
<div class="max-w-7xl mx-auto px-4 pb-20">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('kepala.laporan.buku') }}" class="px-6 py-3 bg-emerald-600 text-white rounded-2xl font-bold shadow-lg shadow-emerald-100 hover:bg-emerald-700 transition-all flex items-center gap-2">
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50/50">
                        <th class="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Info Buku</th>
                        <th class="px-6 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Penerbit & Tahun</th>
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-slate-800 group-hover:text-indigo-600 transition-colors">{{ $item->judul }}</p>
                                    <p class="text-xs text-slate-400 font-medium mt-0.5">Penulis: {{ $item->penulis }}</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-6">
                        ...
                        <td class="px-6 py-6">
                            @if($item->stok > 0)
                                <span class="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black rounded-full uppercase tracking-widest">Tersedia</span>
                            @else
                                <span class="px-3 py-1 bg-red-50 text-red-600 text-[10px] font-black rounded-full uppercase tracking-widest">Habis</span>
                            @endif
                        </td>
                    </tr>
                    @empty
